...
<form action="<?php echo $this->action; ?>" method="POST" enctype="multipart/form-data" id="management" name="management">
	...
	<table cellpadding="0" cellspacing="0" border="0">
		<thead>
			<tr>
				<th colspan="2" class="headline"><?php echo sprintf($GLOBALS['TL_LANG']['DMS']['management_headline'], $GLOBALS['TL_LANG']['DMS']['management_manage_headline'], $GLOBALS['TL_LANG']['DMS']['management_manage_edit_processed_headline']); ?></th>
			</tr>
		</thead>
		<tbody>
			<tr>
	...
	<?php endif; ?>
			...
			<tr>
				<td class="label"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_document_name']; ?></td>
			...
			<tr>
				<td class="label"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_document_keywords']; ?></td>
				<td><?php echo $this->document->keywords; ?></td>
			</tr>
			<tr>
				<td class="label"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_document_version']; ?></td>
				<td><?php echo $this->document->getVersion(); ?></td>
			</tr>
			<tr>
				<td class="label"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_document_publish']; ?></td>
				<td>
		...
		<tfoot>
			<tr>
				<td colspan="2">
					...
					<button type="submit" name="manageCategory" value="<?php echo $this->category->id; ?>"><?php echo $GLOBALS['TL_LANG']['DMS']['management_button_manage_another']; ?></button>
				</td>
			</tr>
		</tfoot>
	</table>
