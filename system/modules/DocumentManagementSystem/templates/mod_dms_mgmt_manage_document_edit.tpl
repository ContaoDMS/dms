...
<form action="<?php echo $this->action; ?>" method="POST" enctype="multipart/form-data" id="management" name="management">
	...
	<input type="hidden" name="editDocument" value="<?php echo $this->document->id; ?>">
	...
	<table cellpadding="0" cellspacing="0" border="0">
		<thead>
			<tr>
				<th colspan="2" class="headline"><?php echo sprintf($GLOBALS['TL_LANG']['DMS']['management_headline'], $GLOBALS['TL_LANG']['DMS']['management_manage_headline'], $GLOBALS['TL_LANG']['DMS']['management_manage_edit_headline']); ?></th>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td class="label"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_category']; ?></td>
				<td>
			...
			<tr class="subheadline">
				<td class="label" colspan="2"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_file_headline']; ?></td>
			</tr>
			<tr>
				<td class="label"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_file_name']; ?></td>
				<td><?php echo $this->document->getFileNameVersioned(); ?></td>
			</tr>
			<tr>
				<td class="label"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_file_type']; ?></td>
				<td><?php echo $this->document->fileType; ?></td>
			</tr>
			<tr>
				<td class="label"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_file_size']; ?></td>
				<td><?php echo $this->document->getFileSize(Document::FILE_SIZE_UNIT_MB, true); ?></td>
			</tr>
	<?php if (count($this->existingDocuments) > 0) : ?>
			<tr class="subheadline">
				<td class="label" colspan="2"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_existing_headline']; ?></td>
			</tr>
		<?php foreach ($this->existingDocuments as $document) : ?>
			<tr>
				<td class="label"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_existing_name']; ?></td>
				<td>
					<?php
	...
	<?php endif; ?>
			<tr class="subheadline">
				<td class="label" colspan="2"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_document_headline']; ?></td>
			</tr>
			<tr>
				<td class="label"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_document_name']; ?><span class="mandatory" title="<?php echo $GLOBALS['TL_LANG']['DMS']['management_mandatory']; ?>">*</span><span class="explanation" title="<?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_document_name_explanation']; ?>"><?php echo $GLOBALS['TL_LANG']['DMS']['management_explanation']; ?></span></td>
				<td><input type="text" id="documentName" name="documentName" maxlength="255" value="<?php echo $this->document->name; ?>" /></td>
			</tr>
			<tr>
				<td class="label"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_document_description']; ?></td>
				<td><textarea id="documentDescription" name="documentDescription" cols="50" rows="5"><?php echo $this->document->description; ?></textarea></td>
			</tr>
			<tr>
				<td class="label"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_document_keywords']; ?><span class="explanation" title="<?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_document_keywords_explanation']; ?>"><?php echo $GLOBALS['TL_LANG']['DMS']['management_explanation']; ?></span></td>
				<td><input type="text" id="documentKeywords" name="documentKeywords" maxlength="255" value="<?php echo $this->document->keywords; ?>" /></td>
			</tr>
			<tr>
				<td class="label"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_document_version']; ?><span class="mandatory" title="<?php echo $GLOBALS['TL_LANG']['DMS']['management_mandatory']; ?>">*</span><span class="explanation" title="<?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_document_version_explanation']; ?>"><?php echo $GLOBALS['TL_LANG']['DMS']['management_explanation']; ?></span></td>
				<td>
					<input type="text" id="documentVersionMajor" name="documentVersionMajor" maxlength="3" size="3" value="<?php echo $this->document->versionMajor; ?>" />
					.
					<input type="text" id="documentVersionMinor" name="documentVersionMinor" maxlength="3" size="3" value="<?php echo $this->document->versionMinor; ?>" />
					.
					<input type="text" id="documentVersionPatch" name="documentVersionPatch" maxlength="3" size="3" value="<?php echo $this->document->versionPatch; ?>" />
				</td>
			</tr>
			<tr>
				<td class="label"><?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_document_publish']; ?><span class="explanation" title="<?php echo $GLOBALS['TL_LANG']['DMS']['management_manage_edit_document_publish_explanation']; ?>"><?php echo $GLOBALS['TL_LANG']['DMS']['management_explanation']; ?></span></td>
			<?php if ($this->category->isPublishableForCurrentMember()) : ?>
				<td><input type="checkbox" id="documentPublish" name="documentPublish" value="true"<?php if ($this->document->isPublished()) : ?> checked="checked"<?php endif; ?> /></td>
			<?php else: ?>
