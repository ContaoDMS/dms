...
$GLOBALS['TL_LANG']['tl_module']['dmsHideLockedCategories']       = array('Gespeerte Kategorien ausblenden', 'Bitte wählen Sie ob gesperrte Kategorien ausgeblendet werden sollen. Beachten Sie, dass dadurch hierachisch untergeordnete Kategorien ggf. auch ausgeblendet sind.');
$GLOBALS['TL_LANG']['tl_module']['dmsHideEmptyCategories']        = array('Leere Kategorien ausblenden', 'Bitte wählen Sie ob leere Kategorien ausgeblendet werden sollen. Beachten Sie, dass dadurch hierachisch untergeordnete Kategorien ggf. auch ausgeblendet sind.');
