...
$GLOBALS['TL_LANG']['tl_dms_categories']['publish_documents_per_default_option'][Category::PUBLISH_DOCUMENTS_PER_DEFAULT_DISABLE] = array('Keine standardmäßige Veröffentlichung', 'Die in diese Kategorie hochgeladenen Dokumente werden standardmäßig nicht veröffentlicht. Die Checkbox zum Veröffentlichen im Verwaltungsmodul (Frontend) ist nicht angekreuzt (ggf. abhängig von Definition in System Einstellungen, Modul und Mitgliedergruppe).');
$GLOBALS['TL_LANG']['tl_dms_categories']['publish_documents_per_default_option'][Category::PUBLISH_DOCUMENTS_PER_DEFAULT_ENABLE]  = array('Dokumente standardmäßig veröffentlichen', 'Die in diese Kategorie hochgeladenen Dokumente werden standardmäßig veröffentlicht. Die Checkbox zum Veröffentlichen im Verwaltungsmodul (Frontend) ist immer angekreuzt.');
