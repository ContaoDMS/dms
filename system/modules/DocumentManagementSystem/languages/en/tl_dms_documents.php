...
$GLOBALS['TL_LANG']['tl_dms_documents']['data_file_size']     = array('File sizy [byte]', 'Specifies the size of the file for this document. This is determined automatically during upload.');
